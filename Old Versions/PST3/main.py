...
def main():
    ...
    while True:
        ...
        print("\n----- Student Manager -----")
        print("S1. Register New Student") Done
        print("S2. Enrol Existing Student") Done
        print("S3. Disenroll Existing Student") Done
        print("S4. Switch Student Course") Done
        print("S5. Update Student Info") Done
        print("S6. Check-in Student") Done
        print("S7. Check Student Attendance") Done
        if is_admin:
            print("S8. (Admin) Remove Student") Done
            print("S9. (Admin) List all Students") Done

        print("\n----- Teacher Manager -----")
        print("T1. Update Teacher Info")
        if is_admin:
            print("T2. (Admin) Register New Teacher") Done
            print("T3. (Admin) Remove Teacher")
            print("T4. (Admin) List all Teachers") Done

        print("\n----- Course Manager -----")
        print("C1. Today's Lessons") Done
        print("C2. List Courses") Done
        print("C3. Get Lessons") Done
        if is_admin:
            print("C4. (Admin) Add Course") Done
            print("C5. (Admin) Remove Course") Done
            print("C6. (Admin) Add lessons ") Done
        print("\n----- Others -----")
        print("O1. Lookup Student, Teacher or Course") Done
        if is_admin:
